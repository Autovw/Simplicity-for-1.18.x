...
public class BlockInit {
    ...
    public static final RegistryObject<Block> EBONY_FOOT = BLOCKS.register("ebony_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR).requiresCorrectToolForDrops()));
