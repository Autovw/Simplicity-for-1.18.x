...
public class ItemInit {
    ...
    public static final RegistryObject<Item> GOLDEN_BERRIES = ITEMS.register("golden_berries", () -> new Item(new Item.Properties().tab(Simplicity.SIMPLICITY).food(new FoodProperties.Builder().nutrition(4).saturationMod(1.0f).effect(new MobEffectInstance(MobEffects.ABSORPTION, 600, 0), 1).effect(new MobEffectInstance(MobEffects.REGENERATION, 100, 1), 1.0F).build())));
